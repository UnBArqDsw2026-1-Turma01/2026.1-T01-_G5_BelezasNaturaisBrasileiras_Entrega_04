...
Este padrão transforma um pedido em um objeto independente que pode ser passado para diferentes receptores.
...
> Refactoring Guru. Command. Disponível em: https://refactoring.guru/design-patterns/command. Acesso em: 18 mai. 2026.
