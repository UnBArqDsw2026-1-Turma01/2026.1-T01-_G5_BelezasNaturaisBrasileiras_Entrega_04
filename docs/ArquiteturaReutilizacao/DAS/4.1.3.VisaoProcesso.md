...
### Diagrama do Pipeline de Requisição — NestJS - Versão 2 (Final)

![Diagrama](../../assets/fase_4/PipelineRequisiçãoNestJS_4_2.png)

### Diagrama do Pipeline de Requisição — NestJS - Versão 1
...
### Diagrama de Fluxo — Finalizar Trilha - Versão 2

![Diagrama](../../assets/fase_4/FinalizarTrilha_4_2.png)

### Diagrama de Fluxo — Finalizar Trilha - Versão 1
...
### Diagrama de Fluxo — Object Pool do Chat - Versão 2 (Final)
![Diagrama](../../assets/fase_4/ObjectPoolChat_4_2.png)

### Diagrama de Fluxo — Object Pool do Chat - Versão 1
...
### Diagrama de Fluxo — Validação de Check-in (Singleton) - Versão 2 - (Final)

![Diagrama](../../assets/fase_4/ValidacaoCheck-in_4_2.png)

### Diagrama de Fluxo — Validação de Check-in (Singleton) - Versão 1
...
| :----- | :--------- | :----------------------------------------------------------------------------------- | :----------------------------------------------------- | :--- | :--- |
| `1.0`  | 11/06/2026 | Criação da visão de processo com 4 diagramas de sequência                            | [Vitor Hoffmann](https://github.com/vitor-hoffmann) e [Ana Pfeilsticker](https://github.com/ana-pfeilsticker) | [Antonio Carvalho](https://github.com/antonioscarvalho) | Revisão técnica da visão de processo: os fluxos de sequência (Signup, Finalizar Trilha e Object Pool) descrevem fielmente as interações entre os padrões GoF implementados. |
| `1.1`  | 13/06/2026 | Atualização técnica dos diagramas (PNG) | [Antonio Carvalho](https://github.com/antonioscarvalho) | — | — |
| `1.2`  | 22/06/2026 | Atualização técnica dos diagramas com mais detalhes e especificações essenciais. | [Antonio Carvalho](https://github.com/antonioscarvalho) | |  |
