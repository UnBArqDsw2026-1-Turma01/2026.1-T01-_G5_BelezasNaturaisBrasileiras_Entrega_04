...
graph LR
  subgraph backend["backend/"]
    NestCLI["NestJS CLI<br/>nest build"]
    TSC["TypeScript 5.7<br/>tsconfig.build.json"]
    PrismaGen["Prisma Client<br/>gerado em src/generated/prisma/"]
    Jest["Jest<br/>npm run test"]
    NestCLI --> TSC --> dist["dist/main.js"]
    PrismaGen --> dist
    Jest --> coverage["coverage/"]
  end

  subgraph frontend["frontend/"]
    Vite["Vite 5<br/>npm run build"]
    TSCFe["TypeScript 5.2"]
    Vite --> TSCFe --> distFe["dist/index.html<br/>dist/assets/"]
  end

  subgraph docs["docs/"]
    Docsify["Docsify 4<br/>GitHub Pages"]
    Mermaid["docsify-mermaid 1.1.0<br/>render diagrams inline"]
    Docsify --> Mermaid
  end
```
...
| :----- | :--------- | :----------------------------------------------------------------------- | :-------------------------------------------------- | :------ | :---------------------- |
| `1.0`  | 11/06/2026 | Criação da visão de implementação: monorepo, estrutura, testes, workflow | [Vitor Hoffmann](https://github.com/vitor-hoffmann) | —       | —                       |
